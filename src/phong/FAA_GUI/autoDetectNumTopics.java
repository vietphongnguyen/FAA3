...
public class autoDetectNumTopics extends JFrame {
	...
	public autoDetectNumTopics(int maxNumTopics) {
		...
		FAA3_GUI.updateAutoDetectTopicsForm() ;
	...
	private void createEvents() {
		...
		btnDetectNumberOf.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				setVisible(false);
				boolean consoleVisible = FAA3_GUI.console.isVisible();
				
				FAA3_GUI.console.setVisible(false);
				try {
				...
				FAA3_GUI.console.setVisible(consoleVisible);
			}
		});
	...
	protected void doAutoDetectNumberOfTopics() {
		...
		// 
		FAA3_GUI.btnCancelMallet.setEnabled(true);
		FAA3_GUI.process_GenerateTopics = null;
		FAA3_GUI.JListOfTopics.removeAllElements();
		try {
			spinnerNumIteration.commitEdit();
			FAA3_GUI.spinnerNumThreards.commitEdit();
			FAA3_GUI.spinnerNumWordsInTopic.commitEdit();
		} catch (ParseException e2) {
			FAA3_GUI.Outln(e2.toString());
		}
		
		FAA3_GUI.threadProcessAutoDetectNumberOfTopics = new processAutoDetectNumberOfTopics( 
				FAA3_GUI.txtTextdatafolder.getText(), numTopicsID,
				Double.parseDouble(FAA3_GUI.textAlphaSum.getText()), Double.parseDouble(FAA3_GUI.textBeta.getText()),
				(int) FAA3_GUI.spinnerNumThreards.getValue(), (int) spinnerNumIteration.getValue(),
				(int) FAA3_GUI.spinnerNumWordsInTopic.getValue());
		try {
			FAA3_GUI.btnEstimateTopics.setEnabled(false);
			FAA3_GUI.btnGetCompositionTable.setEnabled(false);
			FAA3_GUI.threadProcessAutoDetectNumberOfTopics.execute();
		} catch (Exception e1) {
			FAA3_GUI.Outln(e1.toString());
		}
	...
	private void initComponents() {
		...
		labelMinThreshold = new JLabel("0.5");
		...
		spinnerNumIteration.setModel(new SpinnerNumberModel(200, 20, 1000, 1));
		...
		spinnerNumIterationTopword.setModel(new SpinnerNumberModel(400, 50, 2000, 1));
